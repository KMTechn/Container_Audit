param(
    [string]$EvidenceRoot = 'E:\KMTech\autoloop-20260824\seq307-container-sac\sandbox-evidence-001'
)
...
$positiveRoot = 'E:\KMTech\autoloop-20260824\seq307-container-sac\portable-candidate'
$positiveInventoryPath = 'E:\KMTech\autoloop-20260824\seq307-container-sac\portable-pe-inventory.json'
$negativeRoot = 'E:\KMTech\autoloop-20260824\seq280-zero-pe\Container\temp\build-final-head\dist\Container_Audit'
...
$wsbPath = Join-Path $EvidenceRoot 'seq307-container-sac.wsb'
...
if ($negativeHash -cne $expectedNegativeSha256) { throw 'Frozen Container negative-control identity mismatch.' }
...
<Configuration>
  ...
  <MappedFolders>
    <MappedFolder>
      ...
      <SandboxFolder>C:\Seq307\guest</SandboxFolder>
      <ReadOnly>true</ReadOnly>
    </MappedFolder>
    <MappedFolder>
      <HostFolder>$([Security.SecurityElement]::Escape($negativeRoot))</HostFolder>
      <SandboxFolder>C:\Seq307\mapped-negative</SandboxFolder>
      <ReadOnly>true</ReadOnly>
    </MappedFolder>
    <MappedFolder>
      <HostFolder>$([Security.SecurityElement]::Escape($positiveRoot))</HostFolder>
      <SandboxFolder>C:\Seq307\mapped-positive</SandboxFolder>
      <ReadOnly>true</ReadOnly>
    </MappedFolder>
    <MappedFolder>
      <HostFolder>$([Security.SecurityElement]::Escape($EvidenceRoot))</HostFolder>
      <SandboxFolder>C:\Seq307\evidence</SandboxFolder>
      <ReadOnly>false</ReadOnly>
    </MappedFolder>
  </MappedFolders>
  <LogonCommand>
    <Command>powershell.exe -NoProfile -NonInteractive -ExecutionPolicy Bypass -File C:\Seq307\guest\guest.ps1</Command>
  </LogonCommand>
</Configuration>
"@
...
$hostRun = [pscustomobject][ordered]@{
    schema = 'seq307-container-sandbox-host/v1'
...
if ($summary.verdict -cne 'PASS_SAC_ENFORCE_CONTAINER_NEGATIVE_THEN_PORTABLE_GUI') {
