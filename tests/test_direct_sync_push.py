...
@pytest.mark.parametrize(
    ...
    [
        ...
        ({"projection_disposition": "__DELETE__"}, "producer_receipt_invalid"),
        ({"projection_disposition": None}, "producer_receipt_invalid"),
        ({"projection_disposition": 1}, "producer_receipt_invalid"),
        ({"projection_disposition": "REQUIRED_NOT_PROJECTED"}, "producer_projection_incomplete"),
        ({"projection_disposition": "RAW_LEGITIMATE"}, "producer_projection_incomplete"),
        ({"projection_disposition": "UNKNOWN"}, "producer_projection_incomplete"),
        ({"projection_disposition": "ASSUMED_COMPLETE"}, "producer_projection_incomplete"),
