...
def test_phase_g_container_audit_runtime_report_is_local_pass_but_production_blocked(tmp_path):
    ...
    assert runtime_report["evidence"] == "container_audit_runtime_relay_report"
    assert runtime_report["requested_evidence"] == "container_audit_runtime_relay_report"
    ...
    assert runtime_report["flow"] == "ContainerAudit"
    assert runtime_report["producer_repo"] == "Container_Audit"
    assert runtime_report["source_host_id"] == "container-phase-g-host"
    assert runtime_report["producer_install_id"] == "install-container-phase-g"
    ...
    assert runtime_report["task_or_service_name"] == "direct-sync-relay-container-audit"
    ...
    assert runtime_artifact["evidence"] == "container_audit_runtime_relay_report"
